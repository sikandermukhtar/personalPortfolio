...
order: 12
description: "A robust FastAPI-based backend for text classification, featuring sentiment analysis (IMDB) and sincere vs. insincere question detection (Quora)."
githubUrl: "https://github.com/sikandermukhtar/text-classification"
technologies:
  - "FastAPI"
  - "PostgreSQL"
  - "Machine Learning"
...
detailSections:
  - title: "Project Scope"
    items:
      - "Designed a robust FastAPI backend supporting ML model inference and authentication."
      - "Implemented dual text classification models for sentiment (IMDB) and sincere questions (Quora)."
      - "Structured PostgreSQL data models, migrations with Alembic, and JWT security."
  - title: "What It Demonstrates"
    items:
      - "Full-stack ML API deployment using FastAPI."
      - "Database schema design, ORM relationships, and migrations."
      - "Authentication, hashing, and token-based protected endpoints."
---

## Overview

A robust FastAPI-based backend for text classification, featuring sentiment analysis (IMDB) and sincere vs. insincere question detection (Quora). Code related to model training and dataset EDA is in `text-classification.ipynb`.
...
git clone https://github.com/sikandermukhtar/text-classification.git
